-- FIX ALL DASHBOARD TABLE ACCESS
-- This script sets up RLS for all tables the dashboard needs
...
-- ============================================================================
-- 4. DAILY_SALES_METRICS TABLE (if it exists)
-- ============================================================================
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'daily_sales_metrics') THEN
...
-- ============================================================================
-- 5. VARIANT_METRICS TABLE (if it exists)
-- ============================================================================
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'variant_metrics') THEN
...
SELECT 
    ...
    roles
FROM pg_policies
WHERE tablename IN ('sales', 'sale_line_items', 'daily_sales_metrics', 'variant_metrics')
