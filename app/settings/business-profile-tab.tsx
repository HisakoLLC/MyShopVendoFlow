            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-6">
                {logoUrl ? (
                  ...
                  <div className="flex w-16 h-16 items-center justify-center rounded-md bg-muted border border-border">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input 
                      ...
                      {...field} 
                      className="bg-background border border-border rounded-md text-sm text-foreground px-3 py-2 w-full placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-[#E8400C] focus:border-[#E8400C] h-9"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input 
                        ...
                        {...field} 
                        value={field.value || ""} 
                        className="font-mono bg-background border border-border rounded-md text-sm text-foreground h-9 px-3 w-full placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-[#E8400C] focus:border-[#E8400C]"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
