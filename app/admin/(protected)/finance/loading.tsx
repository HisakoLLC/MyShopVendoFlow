  ...
  return (
    <div className="px-8 py-8 animate-pulse max-w-7xl mx-auto space-y-12">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="h-28 bg-[#111] border border-[#1f1f1f] rounded-2xl" />
        ))}
      </div>

      <div className="h-[300px] bg-[#111] border border-[#1f1f1f] rounded-2xl" />

      <div className="space-y-4">
        <div className="h-4 w-40 bg-[#1a1a1a] rounded" />
        <div className="bg-[#111] border border-[#1f1f1f] rounded-2xl overflow-hidden">
          <div className="h-16 border-b border-[#1f1f1f]" />
          {[...Array(5)].map((_, i) => (
            <div key={i} className="h-20 border-b border-[#1f1f1f] flex items-center px-10 gap-10">
