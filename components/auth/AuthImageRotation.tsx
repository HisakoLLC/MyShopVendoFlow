...
export function AuthImageRotation() {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-[2rem] bg-card shadow-2xl border border-border">
        ...
        >
          {doesActiveImageExist ? (
            ...
            <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-muted to-background">
              <span className="font-editorial text-muted-foreground text-6xl opacity-20 select-none">
                Fashion Design
              </span>
            </div>
          )}
